...
public class CatLoadingView extends DialogFragment {
  ...
  @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    if (mDialog == null) {
      mDialog = new Dialog(getActivity(), R.style.CustomProgressBarStyle);
      mDialog.setContentView(R.layout.custom_progess_bar);
      ...
      eye_left_Anim.setDuration(duration);
      ...
      eye_right_Anim.setDuration(duration);
